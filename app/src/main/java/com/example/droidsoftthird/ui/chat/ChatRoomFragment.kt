package com.example.droidsoftthird.ui.chat
...
import com.example.droidsoftthird.EventObserver
...
class ChatRoomFragment : Fragment() {
    ...
    private val navArgs by navArgs<com.example.droidsoftthird.ChatRoomFragmentArgs>()
...
/*    private val requestWritePermissionLauncher =
    ...
    override fun onCreateView(
        ...
        val groupId = com.example.droidsoftthird.ChatRoomFragmentArgs.fromBundle(requireArguments()).groupId
        ...
        viewModel.navigationToGroupDetail.observe(viewLifecycleOwner, EventObserver{
            findNavController().navigate(
                com.example.droidsoftthird.ChatRoomFragmentDirections.actionChatRoomFragmentToGroupDetailFragment(groupId))
        })

        viewModel.navigationToSchedule.observe(viewLifecycleOwner, EventObserver{
            findNavController().navigate(
                com.example.droidsoftthird.ChatRoomFragmentDirections.actionChatRoomFragmentToScheduleFragment(groupId))
        })

        viewModel.navigationToVideo.observe(viewLifecycleOwner, EventObserver{
            findNavController().navigate(
                com.example.droidsoftthird.ChatRoomFragmentDirections.actionChatRoomFragmentToVideoFragment(groupId))
        })
