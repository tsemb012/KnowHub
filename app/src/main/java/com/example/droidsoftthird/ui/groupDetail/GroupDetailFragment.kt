package com.example.droidsoftthird.ui.groupDetail
...
class GroupDetailFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val groupId = com.example.droidsoftthird.GroupDetailFragmentArgs.fromBundle(requireArguments()).groupId
        ...
        viewModel.navigateToMyPage.observe(viewLifecycleOwner, Observer { groupId ->
            groupId?.let {
                this.findNavController().navigate(
                    com.example.droidsoftthird.GroupDetailFragmentDirections.actionGroupDetailFragmentToMyPageFragment()
                )
