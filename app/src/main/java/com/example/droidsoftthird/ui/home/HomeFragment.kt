package com.example.droidsoftthird.ui.home
...
import com.example.droidsoftthird.HomeViewPagerAdapter
...
class HomeFragment: Fragment() {
    ...
    override fun onCreateView(
        ...
        binding_header = DataBindingUtil.inflate(layoutInflater,
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        appBarConfiguration = AppBarConfiguration.Builder(setOf(R.id.homeFragment,
            ...
            R.id.videoFragment)).setOpenableLayout(
        ...
        binding.floatingActionButton.setOnClickListener(View.OnClickListener { v ->
            val action: NavDirections =
                com.example.droidsoftthird.HomeFragmentDirections.actionHomeFragmentToAddGroupFragment()
