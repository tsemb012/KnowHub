...
class ProfileEditFragment : ProfileSubmitFragment() {
    ...
    private fun disableItems() {
        ...
        binding.ageItem.itemProfileEditText.setTextColor(ContextCompat.getColor(requireContext(),
            R.color.dark_gray
        ))
        binding.genderItem.itemProfileEdit.isEnabled = false
        binding.genderItem.itemProfileEditText.setTextColor(ContextCompat.getColor(requireContext(),
            R.color.dark_gray
        ))
    }
